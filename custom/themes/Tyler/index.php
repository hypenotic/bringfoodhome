...
<!--         <div class="dark-overlay"></div> -->
    ...
    echo _e(stripslashes($ef_options['ef_herotitle']),'tyler');
        ...
        <?php if (isset($ef_options['ef_herotagline'])) {
            echo _e(esc_attr(stripslashes($ef_options['ef_herotagline'])),'tyler');
        } ?>
        </p>
        <?php
...
?>
    ...
    echo _e(stripslashes($ef_options['ef_eventcitycountry']),'tyler');
} ?></span>
                            <span class="desc"><?php if (isset($ef_options['ef_eventlocation'])) {
    echo _e(stripslashes($ef_options['ef_eventlocation']),'tyler');
} ?></span>
                        </div>
                    </div>
                </div>
